...
int main()
{
    ...
    while (true)
    {
        ...
        cout << endl << "(ONCORE = 1)" << endl << "(CENTERPOINT ENERGY = 2)" << endl << "(AEP TEXAS CENTERAL = 3)" << endl << "(APE TEXAS NORTH = 4)" << endl << "(TEXAS - NEW MEXICO POWER = 5)" << endl << "What TDU are you currently using? : ";
        ...
        cout << "Total Cost : " << totalTXU + totalTDU << endl << endl;
